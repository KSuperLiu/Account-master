...
public class MainActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    private InvestFragment mInvestFragment;   //投资
    private DetailFragment mDetailFragment;   //明细
    private MineFragment mMineFragment;      //我的
    private PieFragment mPieFragment;        //图表
    ...
    /**
     *
     * @param newFragment  传入要添加的fragment
     */
