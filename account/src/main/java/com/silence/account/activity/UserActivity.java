...
public class UserActivity extends BaseActivity {
    private static final int FROM_CAMERA = 0x1;  //从照相机
    private static final int FROM_GALLERY = 0x2;  //从图库中
    private static final int CROP_PHOTO = 0x3;   //
    private static final int MODIFY_NAME = 0X4;    //改变名字
...
//                                            L.i("文件上传成功：" + fileName + ",可访问的文件地址：" + file.getUrl());
                                        ...
                                        public void onError(int statuscode, String errormsg) {
                                            L.i("文件上传失败：" + statuscode+errormsg);
                                        }
                                    });
                            return null;
                        }
